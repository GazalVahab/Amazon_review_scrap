...
class AmazonReviewsSpider(scrapy.Spider):
    ...
    def parse_reviews(self, response):
        ...
        ## Get Next Page Url
        next_page_relative_url = response.css('.a-pagination .a-last a::attr(href)').get()  # Corrected selector
        ...
        for review_element in review_elements:
            yield {
                ...
                "rating": review_element.css("i[data-hook*=star-rating] span::text").re(r"(\d+\.*\d*) out")[0],  # Corrected selector
            }